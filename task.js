...
function getTasks() {
    ...
    let tasks;
    if (localStorage.getItem("tasks") === null) { //local storage save the value in tasks and check condition(compare)
        tasks = [];
    } else {
    ...
    tasks.forEach(function (task) { //iterating value here task mens any object we can take here task mens i
        // Create li element
...
function removeTaskFromLocalStorage(taskItem) {  //task item mens (e.target.parentElement.parentElement);
    ...
    tasks.forEach(function (task, index) {  //here task mens arr value and index mens index Value
